...
function validate() {
	...
	/* Additional Password Rules */
	 if (pwd1.length < 8) { // must be at least 8 digits.
		errMsg += "Password must be at least 8 characters long.\n";
	}
	if (!/[A-Z]/.test(pwd1) || !/[a-z]/.test(pwd1)) { //ust contain at least one uppercase letter and one lowercase letter.
		errMsg += "Password must contain at least one uppercase and one lowercase letter.\n";
	}
