...
function validate() {
	var fileName =  document.getElementById("tbFile").value.trim();		//obtain the XML filename from the text box
...
function init() {
	$("#btnExecute").on("click", execute);		//link function execute() to the click event of the button
